...
class Dhcp6Pkt(Pkt):
    ...
    def __init__(self, args):
        ...
        if args.filter:
            ...
            self.ether_ipv6_udp = (self.ether / IPv6(src=Tools.get_local_ipv6(), dst=self.args.dhcp_server) / self.udp)
...
class Dhcp4Pkt(Pkt):
    ...
    def __init__(self, args: Namespace):
        ...
        if args.filter:
            self.bootp = BOOTP(chaddr=self.mac, flags=1, giaddr='0.0.0.0', xid=random.randint(1, 900000000))
